...
<!-- LAB-INDEX-START -->
- [Context-Aware Vulnerability Prioritization: Matching CVEs to Network Documentation](./labs/2026-08-28-cve-network-context-prioritization.md): researching CVEs against an internal server segment and an external screened subnet, then cross-referencing network documentation (OS, segment, internet access direction) to set real mitigation priority instead of ranking on CVSS score alone.
